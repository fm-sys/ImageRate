...
#region public methods
		...
		public bool CheckToolExists()
		{
			...
			string output="";
			if (! File.Exists(GetAppPath() + "\\exiftool.exe"))
			{
				return false;
			}
			else
		...
		public void StoreRating(string path, int rating)
		{

            // todo: maybe add "-overwrite_original" if we don't want to add an backup file
